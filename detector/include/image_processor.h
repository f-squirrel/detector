...
typedef std::unique_ptr<source> source_ptr_t;
typedef std::unique_ptr<image_display> display_ptr_t;
typedef std::unique_ptr<object_detector> object_detector_ptr_t;
